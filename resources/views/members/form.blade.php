    ...
    <div class="flex flex-col w-full text-center">
      <h1 class="mb-4 text-2xl font-medium text-gray-900 sm:text-3xl title-font">
        <font style="vertical-align: inherit;">
          <font style="vertical-align: inherit;">お問い合わせフォーム</font>
        </font>
      </h1>
    </div>
    <div class="mx-auto lg:w-1/2">
      <div class="flex flex-wrap">
        <div class="w-full p-2">
          <div class="relative">
            <form action="{{ route('member_contacts') }}" method="POST">
              @csrf
              ...
              <button type="submit" class="flex px-8 py-2 mx-auto text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">
                <span>送信</span>
              </button>
            </form>
          </div>
